 ...
 <div class="col-md-8 col-sm-8 col-xl-4 col-lg-5 formulario">
    ...
    @method('PUT')
       <div class="form-group text-center pt-3">
        ...
        <div class="form-group mx-sm-4 pt-3">
         <input type="text" class="form-control" name= "n_Personas" value="{{$reserva->n_Personas}}">
        </div><br>
        ...
        <div class="form-group mx-sm-4 pt-3">
         <input type="text" class="form-control" name= "f_pago" value="{{$reserva->f_pago}}">
        </div>
        <div class="form-group mx-sm-4 pt-3">
         <input type="number" class="form-control" name= "total" value="{{$reserva->precio_tot}}">
        </div><br>
